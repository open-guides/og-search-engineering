...
Ask a software engineer: “[How would you add search functionality to your product?](https://stackoverflow.com/questions/34314/how-do-i-implement-search-functionality-in-a-website)” or “[How do I build a search engine?](https://www.quora.com/How-to-build-a-search-engine-from-scratch)” You’ll probably immediately hear back something like: “Oh, we’d just launch an ElasticSearch cluster. Search is easy these days.”
...
Oh, all the different shapes and sizes of search spam! A giant topic in itself, worthy of a separate guide. [A good web spam taxonomy overview](http://airweb.cse.lehigh.edu/2005/gyongyi.pdf).
...
* Various ElasticSearch providers: AWS (☁️ [**ElasticSearch Cloud**)](https://aws.amazon.com/elasticsearch-service/), ☁️[**elastic.co**](https://www.elastic.co/) and from ☁️ [**Qbox**](https://qbox.io/).
...
* OpenStreetMaps has it’s own 🍺[deck of search software](http://wiki.openstreetmap.org/wiki/Search_engines).
...
Special thanks to* *[Joshua Levy](https://twitter.com/ojoshe),* *[Leo Polovets](https://twitter.com/lpolovets)* *and* *[Abhishek Das](https://www.linkedin.com/in/abhishek-das-3280053/)* *for reading drafts of this and their invaluable feedback!
